...
class draw_helper(object):
    ...
    def showFrame(self, frame):
        ...
        output_frame = orig_image.resize((output_width, output_height))
        display = output_frame.resize((display_width, display_height), Image.ANTIALIAS)
        c = orig_image.getcolors(input_width * input_height)
        if c:
